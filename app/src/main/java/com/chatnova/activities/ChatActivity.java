...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage() {
        ...
        message.put(Constants.KEY_TIMESTAMP, new java.util.Date()); // Adding timestamp
    ...
    private void sendNotifications(String messageBody) {
        ApiClient.getClient().create(ApiService.class).sendMesssage(
                Constants.getRemoteMshHeaders(),
                messageBody
